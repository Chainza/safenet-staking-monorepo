  ...
  return (
    <LegalArticle title="Terms of Service" updated="4 August 2026">
      <LegalSection title="1. About these terms">
        <p>
          These terms govern your use of this website and the SAFE staking interface it hosts (the
          &ldquo;Interface&rdquo;), operated by LIMITED LIABILITY COMPANY &ldquo;CHAINZA&rdquo;
          (&ldquo;Chainza&rdquo;, &ldquo;we&rdquo;) — see the{" "}
          <Link
            to="/imprint"
            className="font-medium text-[var(--page-fg)] underline decoration-[var(--page-border)] underline-offset-4"
          >
            Imprint
          </Link>{" "}
      ...
      <LegalSection title="2. The Interface">
        <p>
          The Interface is a non-custodial web application that lets you interact with the Safenet
          Beta staking smart contracts on Ethereum mainnet: staking SAFE with a validator,
          initiating and claiming withdrawals, and claiming staking rewards. It runs entirely in
          your browser.
        </p>
        <p>
          The Safenet protocol, the staking and rewards contracts and the SAFE token are developed
          and published by the Safe Ecosystem Foundation and its contributors. Chainza did not
          develop and does not control those contracts, does not operate validators, and is not a
          party to any transaction you submit. Your keys and your tokens never leave your control:
          every transaction is composed locally and signed by your own wallet.
        </p>
      </LegalSection>

      <LegalSection title="3. No advice, no brokerage">
        <p>
          Nothing on the Interface constitutes investment, financial, legal or tax advice, an offer,
          or a solicitation. Chainza does not broker transactions, execute them on your behalf, or
          receive your assets at any point. You use the Interface at your own initiative and are
      ...
      <LegalSection title="5. Risks">
        <p>
          ...
          does not exist in Safenet Beta but may be introduced post-Beta; rewards for a period are
          forfeited if your validator&rsquo;s participation falls below the protocol threshold; and
          the staking contracts — like all smart contracts — may contain bugs. Safenet Beta is
      ...
      <LegalSection title="6. Fees">
        <p>
          The Interface itself charges no fees. Network (gas) fees and any validator commission are
          set by the network and the protocol respectively and are outside Chainza&rsquo;s control.
        </p>
      </LegalSection>
      ...
      <LegalSection title="10. Disclaimer and limitation of liability">
        <p>
          ...
          profits, or loss of tokens or other digital assets arising from your use of the Interface,
          the conduct of the underlying smart contracts and protocol, or the failure of third-party
          services. Nothing in these terms excludes liability that cannot be excluded under
          applicable law.
        </p>
      </LegalSection>
      ...
      <LegalSection title="11. Governing law">
        <p>
          ...
          connection with them is subject to the jurisdiction of the competent courts of Ukraine.
        </p>
      </LegalSection>
      ...
      <LegalSection title="12. Changes to these terms">
        <p>
          ...
          with an updated date. Your continued use of the Interface after a revision takes effect
